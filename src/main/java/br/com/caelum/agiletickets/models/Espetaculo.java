...
public class Espetaculo {
	...
	public List<Sessao> criaSessoes(LocalDate inicio, LocalDate fim,
		...
		for(int i = 0; i <= dias; i += periodicidade.getPeriodo()) {
			sessoes.add(criaSessao(inicio.plusDays(i).toDateTime(horario), 60));
		}
	...
	private Sessao criaSessao(DateTime inicio, int duracao) {
